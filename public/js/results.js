...
async function getAuthorInfo() {
    ...
    dqs("#dob").textContent = data[0][0].dob;
    dqs("#dod").textContent = data[0][0].dod;
    dqs("#bp").textContent = data[0][0].country;
    dqs("#prof").textContent = data[0][0].profession;
    dqs("#gender").textContent = data[0][0].sex;
    dqs("#bio").textContent = data[0][0].biography;
